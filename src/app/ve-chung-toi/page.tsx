...
export const metadata: Metadata = {
  ...
  description: `MAX OFFICE thành lập từ 2022, đồng hành cùng hơn ${TRUSTED_BUSINESS_COUNT} doanh nghiệp tại ${ACTIVE_BRANCH_COUNT} địa điểm trung tâm TP.HCM. Tìm hiểu câu chuyện, tầm nhìn, sứ mệnh và giá trị cốt lõi của chúng tôi.`,
  ...
  return (
    <main>
      <PageHero
        ...
        description={`Từ một địa chỉ tại Tân Bình năm 2022, MAX OFFICE đã trở thành hệ thống ${ACTIVE_BRANCH_COUNT} địa điểm, đồng hành cùng hơn ${TRUSTED_BUSINESS_COUNT} doanh nghiệp trên hành trình khởi nghiệp và phát triển.`}
      />
