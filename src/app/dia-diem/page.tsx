...
export const metadata: Metadata = {
  ...
  title: "16 Chi Nhánh Văn Phòng MAX OFFICE Tại TP.HCM",
  description:
    "Danh sách đầy đủ 16 chi nhánh văn phòng ảo, văn phòng trọn gói và coworking của MAX OFFICE, nhóm theo 7 khu vực tại Tân Bình, Gò Vấp, Tân Phú, Quận 10, Quận 1, Quận 7 và Thủ Đức, TP.HCM.",
  openGraph: {
  ...
  return (
    <main>
      <PageHero
        ...
        eyebrow="Chi nhánh"
        title="16 chi nhánh văn phòng tại TP.HCM"
      ...
      <section className="py-9">
        <div className="mx-auto max-w-[1240px] px-5 sm:px-8">
          <SectionHead
            ...
            title="Toàn bộ 16 chi nhánh MAX OFFICE"
