...
const INTRO = [
  ...
  "Ba chi nhánh áp dụng ba bảng giá khác nhau: Phạm Văn Đồng có 3 gói M-START (370.000đ/tháng), M-BASE (500.000đ/tháng) và M-ORIGIN (800.000đ/tháng); 27C Quốc Hương áp dụng SILVER (379.000đ/tháng), GOLD (490.000đ/tháng) và PREMIUM (990.000đ/tháng); còn 28 Mai Chí Thọ — địa chỉ đầu tiên MAX OFFICE áp dụng bảng giá đối tác riêng — dùng hệ giá riêng CORE, PLUS (cùng 499.000đ/tháng) và PRO (899.000đ/tháng). Tất cả giá đều chưa bao gồm VAT 10%.",
