...
export default function ThuDucCuPage() {
  return (
    <AreaPageTemplate
      area={area}
      heroTitle="Chi Nhánh MAX OFFICE Tại Thủ Đức (cũ)"
