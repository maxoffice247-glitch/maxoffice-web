...
export const metadata: Metadata = {
  ...
  title: "Văn Phòng Ảo Thành phố Thủ Đức (cũ) — 2 Chi Nhánh | MAX OFFICE",
  description:
    "2 chi nhánh MAX OFFICE tại khu vực Thành phố Thủ Đức (cũ): Phạm Văn Đồng và 27C Quốc Hương (Phường An Khánh). Văn phòng ảo từ 370.000đ/tháng, gần các trường đại học lớn và khu Thảo Điền.",
};
...
const INTRO = [
  ...
  "Nếu doanh nghiệp bạn cần địa chỉ gần các trường đại học lớn, hãy chọn Phạm Văn Đồng; nếu ưu tiên khu vực quốc tế hoá, sầm uất gần Thảo Điền, 27C Quốc Hương là lựa chọn phù hợp — cả hai đều là lựa chọn đáng cân nhắc tại khu vực Thành phố Thủ Đức (cũ) trong hệ thống MAX OFFICE.",
];
