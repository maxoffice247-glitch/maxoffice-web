...
const INTRO = [
  ...
  "Hai chi nhánh dùng hai hệ giá KHÁC NHAU. 89 Phan Đình Phùng áp dụng 3 gói SILVER (379.000đ/tháng), GOLD (490.000đ/tháng) và PREMIUM (990.000đ/tháng) — cùng bảng giá đang dùng tại các chi nhánh khu vực Bình Thạnh và Thủ Đức, phân hoá theo thời lượng dùng phòng họp, sảnh tiếp khách và hỗ trợ pháp lý. 68 Phan Đăng Lưu áp dụng 3 gói CORE, PLUS (cùng 499.000đ/tháng) và PRO (899.000đ/tháng) thuộc hệ đối tác riêng — khác cả hệ thống LITE–RISE chung của MAX OFFICE lẫn hệ SILVER/GOLD/PREMIUM của 89 Phan Đình Phùng. Toàn bộ mức giá của cả hai chi nhánh đều chưa bao gồm thuế VAT 10%.",
