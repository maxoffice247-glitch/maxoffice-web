...
export const metadata: Metadata = {
  ...
  title: "Văn Phòng Ảo Quận Phú Nhuận (cũ) — Chi Nhánh 89 Phan Đình Phùng | MAX OFFICE",
  description:
    "Chi nhánh MAX OFFICE tại khu vực Quận Phú Nhuận (cũ): 89 Phan Đình Phùng, Phường Phú Nhuận. Văn phòng ảo từ 379.000đ/tháng (gói SILVER, GOLD, PREMIUM), gần chợ Phú Nhuận.",
};

const INTRO = [
  "Quận Phú Nhuận (cũ) là khu vực mới nhất trong hệ thống MAX OFFICE, đánh dấu bằng chi nhánh đầu tiên tại 89 Phan Đình Phùng, Phường Phú Nhuận — khu vực trung tâm giáp ranh Quận 1, Quận 3, Bình Thạnh và Tân Bình. Đây là lựa chọn phù hợp cho doanh nghiệp cần một địa chỉ đăng ký kinh doanh trung chuyển thuận tiện giữa nhiều khu vực trung tâm thành phố.",
  ...
  "Nếu doanh nghiệp bạn cần một địa chỉ đăng ký kinh doanh ở vị trí trung tâm, kết nối thuận tiện nhiều hướng mà không phải đặt văn phòng ngay khu lõi với chi phí cao hơn, chi nhánh 89 Phan Đình Phùng là lựa chọn phù hợp tại khu vực Quận Phú Nhuận (cũ) trong hệ thống MAX OFFICE.",
];
