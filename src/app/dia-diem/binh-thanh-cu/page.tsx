...
export const metadata: Metadata = {
  ...
  title: "Văn Phòng Ảo Quận Bình Thạnh (cũ) — 3 Chi Nhánh | MAX OFFICE",
  description:
    "3 chi nhánh MAX OFFICE tại khu vực Quận Bình Thạnh (cũ): 161 Ung Văn Khiêm, 23 Tân Cảng và N1 Điện Biên Phủ, cùng Phường Thạnh Mỹ Tây. Văn phòng ảo từ 379.000đ/tháng (gói SILVER, GOLD, PREMIUM).",
};

const INTRO = [
  "Quận Bình Thạnh (cũ) hiện có 3 chi nhánh MAX OFFICE, cùng thuộc Phường Thạnh Mỹ Tây: 161 Ung Văn Khiêm, 23 Tân Cảng và N1 Điện Biên Phủ — khu vực cửa ngõ Đông Bắc trung tâm thành phố, kết nối thuận tiện giữa trung tâm Quận 1 và khu vực phía Đông thành phố.",
...
export default function BinhThanhCuPage() {
  return (
    <AreaPageTemplate
      area={area}
      heroTitle="Chi Nhánh MAX OFFICE Tại Quận Bình Thạnh (cũ)"
