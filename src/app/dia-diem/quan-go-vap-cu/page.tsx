...
export const metadata: Metadata = {
  ...
  description:
    "Chi nhánh MAX OFFICE tại khu vực Quận Gò Vấp (cũ): Nguyễn Oanh. Văn phòng ảo hạng A từ 595.000đ/tháng, gần sân bay Tân Sơn Nhất.",
};
