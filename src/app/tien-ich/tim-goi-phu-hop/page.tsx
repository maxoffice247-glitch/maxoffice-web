...
export const metadata: Metadata = {
  ...
  description: `Chọn khu vực và ngân sách mong muốn, nhận ngay danh sách gói văn phòng ảo phù hợp trong ${ACTIVE_BRANCH_COUNT} chi nhánh MAX OFFICE — kèm giá, tính năng, ảnh mặt tiền và báo giá tải về.`,
};

const BENEFITS = [
  { icon: ClockIcon, title: "Kết quả tức thì", desc: "Chọn khu vực và ngân sách, nhận ngay danh sách gói phù hợp không cần chờ tư vấn." },
  { icon: ScaleIcon, title: "So sánh toàn hệ thống", desc: `Đối chiếu cùng lúc ${ACTIVE_BRANCH_COUNT} chi nhánh, dữ liệu giá đúng bảng giá hiện hành của từng chi nhánh.` },
