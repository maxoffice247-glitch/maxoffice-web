  ...
  return (
    ...
    >
      ...
      <body className="min-h-screen bg-bg font-sans text-ink antialiased" suppressHydrationWarning>
        ...
        {/* Widget chat Tidio — nay chỉ tải sau tương tác đầu tiên của
            người dùng, xem DeferredTidio.tsx để biết lý do (đo Lighthouse
            mobile cho thấy "lazyOnload" vẫn không đủ, chi phí CPU thực thi
            widget.js mới là vấn đề chính). */}
        <DeferredTidio />
      </body>
    </html>
  );
