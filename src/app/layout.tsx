...
export const metadata: Metadata = {
  ...
  description:
    "MAX OFFICE đồng hành cùng hơn 500 doanh nghiệp tại 16 địa điểm trung tâm TP.HCM với văn phòng ảo, văn phòng trọn gói, coworking, phòng họp, thành lập doanh nghiệp và kế toán thuế.",
  icons: {
    icon: [
