...
export const SERVICES_DATA: Record<string, ServiceData> = {
  "van-phong-ao": {
    ...
    faqs: [
      ...
      { q: "Tôi có thể đổi địa chỉ chi nhánh trong quá trình sử dụng không?", a: "Có thể, tuỳ tình huống cụ thể. Việc đổi địa chỉ đăng ký kinh doanh cần thực hiện thủ tục thay đổi với cơ quan đăng ký kinh doanh — đội ngũ MAX OFFICE sẽ tư vấn và hỗ trợ hồ sơ." },
  ...
  "ke-toan-thue": {
    ...
    metaDescription:
      "Dịch vụ kế toán thuế trọn gói từ 800.000đ/tháng. Đúng hạn, đúng luật, tối ưu thuế hợp pháp. 500+ doanh nghiệp tin dùng.",
    intro: [
      ...
      "Chúng tôi cung cấp hai gói dịch vụ tương ứng với quy mô doanh thu: gói Startup dành cho doanh nghiệp có doanh thu dưới 1 tỷ đồng/năm, và gói Business dành cho doanh nghiệp có doanh thu từ 1-10 tỷ đồng/năm. Với doanh nghiệp quy mô lớn hơn, đội ngũ MAX OFFICE sẵn sàng tư vấn và báo giá riêng theo khối lượng nghiệp vụ thực tế.",
    ...
    pricingDescription: "Chọn gói phù hợp với quy mô doanh thu của doanh nghiệp.",
    pricing: {
      mode: "tiers",
      tiers: [
        {
          ...
          price: "800.000đ",
          unit: "/ tháng",
          desc: "Dành cho doanh nghiệp có doanh thu dưới 1 tỷ đồng/năm.",
        ...
        },
        {
          ...
          price: "1.500.000đ",
          unit: "/ tháng",
          desc: "Dành cho doanh nghiệp có doanh thu từ 1-10 tỷ đồng/năm.",
        ...
        },
        {
          ...
          unit: "theo khối lượng nghiệp vụ",
          desc: "Dành cho doanh nghiệp quy mô lớn, khối lượng giao dịch cao.",
          features: ["Kế toán trưởng phụ trách riêng", "Báo cáo quản trị theo yêu cầu", "Tư vấn thuế và pháp lý chuyên sâu"],
        },
      ],
    },
    process: [
      { num: "01", title: "Liên hệ tư vấn", desc: "Chia sẻ quy mô doanh thu và nhu cầu kế toán hiện tại." },
      { num: "02", title: "Chọn gói phù hợp", desc: "Startup, Business hoặc Enterprise theo quy mô doanh nghiệp." },
    ...
    faqs: [
      { q: "Chi phí kế toán thuế đã bao gồm những gì?", a: "Bao gồm kê khai thuế định kỳ, sổ sách kế toán và tư vấn nghĩa vụ thuế hàng tháng, đúng quy định pháp luật hiện hành theo gói đã đăng ký." },
      { q: "Làm sao biết doanh nghiệp mình phù hợp gói Startup hay Business?", a: "Dựa trên doanh thu năm: dưới 1 tỷ đồng phù hợp gói Startup, từ 1-10 tỷ đồng phù hợp gói Business. Đội ngũ tư vấn sẽ xác nhận lại khi bạn đăng ký." },
      { q: "Nếu doanh nghiệp tôi có doanh thu trên 10 tỷ đồng thì sao?", a: "MAX OFFICE cung cấp gói Enterprise với báo giá riêng theo khối lượng nghiệp vụ thực tế của doanh nghiệp." },
      ...
      { q: "Nếu doanh nghiệp chưa phát sinh doanh thu có cần kê khai không?", a: "Có, doanh nghiệp vẫn cần kê khai thuế định kỳ theo quy định ngay cả khi chưa phát sinh doanh thu." },
      { q: "MAX OFFICE có hỗ trợ quyết toán thuế cuối năm không?", a: "Có, dịch vụ bao gồm lập báo cáo tài chính và hỗ trợ quyết toán thuế cuối năm cho doanh nghiệp." },
      ...
      { q: "Tôi có thể đổi gói dịch vụ khi doanh thu tăng không?", a: "Có, bạn có thể nâng cấp gói dịch vụ bất kỳ lúc nào để phù hợp với quy mô phát triển của doanh nghiệp." },
      ...
      { q: "Dịch vụ có phù hợp với doanh nghiệp mới thành lập, chưa có kế toán không?", a: "Rất phù hợp. Gói Startup được thiết kế riêng cho doanh nghiệp mới, chưa có bộ phận kế toán nội bộ." },
      { q: "Tôi có thể xem báo cáo tài chính bất cứ lúc nào không?", a: "Có, đội ngũ kế toán sẽ cập nhật và gửi báo cáo định kỳ, đồng thời hỗ trợ giải đáp khi bạn cần xem báo cáo đột xuất." },
    ],
    testimonials: [
      ...
      { quote: "Chuyển từ gói Startup lên Business khi công ty tăng trưởng, quá trình chuyển đổi rất mượt mà, không gián đoạn.", initial: "P", name: "Hoàng Phúc", role: "CEO, Phuc Thinh Logistics" },
    ],
    comparisonTitle: "Kế toán thuê ngoài so với kế toán nội bộ",
    comparisonAlternative: "Thuê kế toán nội bộ",
    comparison: [
      { criteria: "Chi phí hàng tháng", max: "Từ 800.000đ/tháng, không phát sinh lương thưởng", traditional: "Chi phí lương, bảo hiểm, phúc lợi cao hơn nhiều" },
