...
export const SERVICES_DATA: Record<string, ServiceData> = {
  "van-phong-ao": {
    ...
    metaDescription:
      "Thuê văn phòng ảo TP.HCM giá từ 299.000đ/tháng. 6 gói dịch vụ: Gói LITE, START, BASE, ORIGIN, ORIGIN+, RISE. Địa chỉ pháp lý hợp lệ, 22 chi nhánh. Tư vấn miễn phí.",
    intro: [
    ...
    benefits: [
      { icon: ShieldCheckIcon, title: "Địa chỉ pháp lý hợp lệ", desc: "Đủ điều kiện đăng ký kinh doanh, đăng ký thuế tại 22 địa điểm trung tâm TP.HCM." },
    ...
    process: [
      { num: "01", title: "Liên hệ tư vấn", desc: "Chia sẻ nhu cầu, chọn địa điểm phù hợp trong 22 chi nhánh." },
  ...
  "van-phong-tron-goi": {
    ...
    benefits: [
      ...
      { icon: BuildingIcon, title: "Vị trí trung tâm", desc: "Lựa chọn từ 22 địa điểm tại các quận trung tâm TP.HCM." },
    ...
    pricing: {
      ...
      features: [
        ...
        "Vị trí tại 22 chi nhánh trung tâm TP.HCM",
      ],
    ...
    process: [
      ...
      { num: "02", title: "Tham quan văn phòng", desc: "Chọn chi nhánh và không gian phù hợp trong 22 địa điểm." },
  ...
  "phong-hop": {
    ...
    heroDescription:
      "Phòng họp chuyên nghiệp, trang bị màn hình và âm thanh hiện đại — đặt lịch linh hoạt từ 150.000đ/giờ tại 22 chi nhánh trung tâm TP.HCM.",
    image: "/images/phong-hop.jpg",
    metaTitle: "Cho Thuê Phòng Họp Theo Giờ TP.HCM Từ 150K | MAX OFFICE",
    metaDescription:
      "Phòng họp chuyên nghiệp TP.HCM từ 150.000đ/giờ. Màn hình 4K, âm thanh chuẩn, đặt lịch online 24/7. 22 chi nhánh.",
    intro: [
    ...
    benefits: [
      ...
      { icon: BuildingIcon, title: "Vị trí thuận tiện", desc: "Chọn từ 22 chi nhánh trung tâm TP.HCM gần đối tác, khách hàng." },
    ...
    pricing: {
      ...
      features: [
        ...
        "Vị trí tại 22 chi nhánh trung tâm",
      ],
    ...
    comparison: [
      ...
      { criteria: "Vị trí", max: "22 chi nhánh trung tâm TP.HCM", traditional: "Giới hạn theo địa điểm quán hoặc không gian có sẵn" },
    ],
  },
