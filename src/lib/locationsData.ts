...
export type LocationData = {
  ...
  image: string;
  /** Tỉ lệ thật (W/H) của ảnh mặt tiền — dùng cho khung ảnh trong trang xem
      trước báo giá (/tien-ich/tim-goi-phu-hop/[slug]/[plan], object-contain,
      không cắt). KHÔNG còn dùng ở trang /locations/[slug] — ảnh mặt tiền ở
      đó nay hiển thị trong LocationGallery (Masonry, tự đọc W/H thật qua
...
export const LOCATIONS_DATA: Record<string, LocationData> = {
  ...
  "nguyen-thong": {
    ...
    heroDescription: "Chi nhánh MAX OFFICE tại 60 Nguyễn Thông, Phường Nhiêu Lộc — chi nhánh đầu tiên tại khu vực Quận 3 (cũ), văn phòng ảo 3 gói riêng biệt từ 479.000đ/tháng, toà nhà văn phòng cao tầng hiện đại.",
    metaTitle: "Văn Phòng Ảo 60 Nguyễn Thông, Quận 3 (cũ) | Từ 479K/Tháng",
    metaDescription: "Thuê văn phòng ảo tại 60 Nguyễn Thông, Phường Nhiêu Lộc — 3 gói riêng SILVER/GOLD/PREMIUM từ 479.000đ/tháng (chưa VAT), chi nhánh đầu tiên MAX OFFICE tại khu vực Quận 3 (cũ).",
    image: "/images/coworking.jpg",
    ...
    benefits: [
      ...
      { icon: BadgePercentIcon, title: "3 gói giá linh hoạt", desc: "SILVER, GOLD, PREMIUM — từ 479.000đ/tháng, tuỳ nhu cầu sử dụng." },
    ...
    faqs: [
      { q: "Chi nhánh 60 Nguyễn Thông có những gói văn phòng ảo nào?", a: "Chi nhánh cung cấp 3 gói riêng biệt: SILVER (479.000đ/tháng), GOLD (639.000đ/tháng) và PREMIUM (990.000đ/tháng) — giá chưa bao gồm VAT 10%." },
      { q: "3 gói SILVER, GOLD, PREMIUM khác nhau ở điểm nào?", a: "Cả 3 gói đều có địa chỉ ĐKKD, bảng tên vật lý (mica) tại toà nhà, bảng tên điện tử, tiếp tân và tư vấn miễn phí. Khác biệt nằm ở: thời lượng miễn phí phòng họp và sảnh tiếp khách tăng dần qua từng gói; riêng GOLD và PREMIUM có thêm hỗ trợ chuyển đổi địa chỉ trên GPKD, và chỉ PREMIUM có thêm bộ hồ sơ pháp lý toà nhà." },
      { q: "Giá gói văn phòng ảo tại đây đã bao gồm VAT chưa?", a: "Chưa. Toàn bộ mức giá niêm yết (479.000đ - 990.000đ/tháng tuỳ gói) là giá chưa bao gồm VAT 10%, sẽ được thể hiện rõ trong báo giá chính thức trước khi ký hợp đồng." },
  ...
  "cach-mang-thang-8": {
    ...
    heroDescription: "Chi nhánh MAX OFFICE tại 520 Cách Mạng Tháng 8, Phường Nhiêu Lộc — chi nhánh thứ hai tại khu vực Quận 3 (cũ), văn phòng ảo 3 gói riêng biệt từ 479.000đ/tháng, mặt tiền trục đường lớn.",
    metaTitle: "Văn Phòng Ảo 520 Cách Mạng Tháng 8, Quận 3 (cũ) | Từ 479K/Tháng",
    metaDescription: "Thuê văn phòng ảo tại 520 Cách Mạng Tháng 8, Phường Nhiêu Lộc (Quận 3 cũ) — 3 gói riêng SILVER/GOLD/PREMIUM từ 479.000đ/tháng (chưa VAT). Lưu ý: khác hoàn toàn chi nhánh CMT8 tại Quận 10 (cũ).",
    image: "/images/anh-hero-trang-chu.jpg",
    ...
    intro: [
      ...
      "Cũng như chi nhánh 60 Nguyễn Thông, 520 Cách Mạng Tháng 8 cung cấp 3 gói văn phòng ảo riêng biệt — SILVER (479.000đ/tháng), GOLD (639.000đ/tháng) và PREMIUM (990.000đ/tháng), giá chưa bao gồm VAT 10% — dùng chung bảng giá của khu vực Quận 3 (cũ), phân hoá theo nhu cầu sử dụng phòng họp, sảnh tiếp khách và dịch vụ pháp lý đi kèm.",
    ],
    ...
    faqs: [
      ...
      { q: "Chi nhánh 520 Cách Mạng Tháng 8 áp dụng bảng giá nào?", a: "Chi nhánh dùng chung bảng giá với 60 Nguyễn Thông trong cùng khu vực Quận 3 (cũ), gồm 3 gói: SILVER (479.000đ/tháng), GOLD (639.000đ/tháng) và PREMIUM (990.000đ/tháng) — giá chưa bao gồm VAT 10%." },
  ...
  "mai-chi-tho": {
    ...
    heroDescription:
      "Chi nhánh thứ ba của MAX OFFICE tại khu vực Thủ Đức (cũ) — địa chỉ đầu tiên áp dụng bảng giá đối tác riêng, 3 gói văn phòng ảo CORE/PLUS/PRO từ 499.000đ/tháng, ngay đại lộ Mai Chí Thọ gần hầm Thủ Thiêm và khu trung tâm mới Thủ Đức.",
    metaTitle: "Văn Phòng Ảo 28 Mai Chí Thọ, TP. Thủ Đức | Từ 499K/Tháng",
    metaDescription:
      "Thuê văn phòng ảo tại 28 Mai Chí Thọ, Phường An Khánh (TP. Thủ Đức) — địa chỉ đối tác riêng, 3 gói CORE/PLUS/PRO từ 499.000đ/tháng (chưa VAT), ngay đại lộ Đông Tây, gần hầm Thủ Thiêm và khu đô thị mới Thủ Thiêm.",
    image: "/images/hero-dich-vu.jpg",
    ...
    intro: [
      ...
      "Đây cũng là địa chỉ ĐẦU TIÊN MAX OFFICE áp dụng bảng giá đối tác riêng tại khu vực. Khách hàng có thêm lựa chọn đặt trụ sở tại một trong những trục giao thông sầm uất và dễ nhận diện nhất khu Đông thành phố, với bảng giá riêng gồm 3 gói CORE, PLUS và PRO thay cho hệ thống LITE–RISE chung của MAX OFFICE.",
    ...
    benefits: [
      { icon: BuildingIcon, title: "Địa chỉ đối tác riêng đầu tiên", desc: "Chi nhánh mở đầu cho hệ thống địa chỉ MAX OFFICE áp dụng bảng giá đối tác riêng." },
    ...
    faqs: [
      ...
      { q: "Gói CORE, PLUS, PRO ở chi nhánh này là gì? Khác gì so với hệ LITE–RISE của MAX OFFICE?", a: "Đây là bảng giá riêng của hệ đối tác cung cấp không gian tại địa chỉ này, không dùng chung hệ thống LITE–RISE của các chi nhánh MAX OFFICE khác. CORE và PLUS cùng giá 499.000đ/tháng nhưng khác định hướng (CORE cho người mới chuyển từ cá nhân/hộ kinh doanh, PLUS cho công ty cần địa chỉ hoạt động hợp lệ); PRO 899.000đ/tháng đầy đủ hỗ trợ pháp lý và kế toán cơ bản. Giá chưa gồm VAT 10%." },
      { q: "\"Ưu đãi ra mắt MAX\" trên các gói nghĩa là gì?", a: "Cả 3 gói đang áp dụng mức giá ưu đãi thấp hơn giá gốc nhân dịp MAX OFFICE ra mắt địa chỉ đối tác riêng đầu tiên: CORE và PLUS còn 499.000đ (giá gốc 599.000đ), PRO còn 899.000đ (giá gốc 999.000đ). Bạn nên liên hệ hotline để xác nhận thời hạn ưu đãi còn hiệu lực tại thời điểm ký hợp đồng." },
  ...
  "phan-dang-luu": {
    ...
    heroDescription:
      "Chi nhánh thứ hai của MAX OFFICE tại khu vực Phú Nhuận (cũ) — toà nhà hạng A L'MAK 68 ngay trục Phan Đăng Lưu, 3 gói văn phòng ảo CORE/PLUS/PRO từ 499.000đ/tháng (bảng giá đối tác riêng, chưa VAT), gần ngã tư Phú Nhuận và Cầu Kiệu.",
    metaTitle: "Văn Phòng Ảo 68 Phan Đăng Lưu, Phú Nhuận (cũ) | Từ 499K/Tháng",
    metaDescription:
      "Thuê văn phòng ảo tại 68 Phan Đăng Lưu, Phường Đức Nhuận (khu Phú Nhuận cũ) — toà nhà hạng A L'MAK 68, 3 gói CORE/PLUS/PRO từ 499.000đ/tháng (chưa VAT, bảng giá đối tác riêng), khác hệ giá SILVER/GOLD/PREMIUM của 89 Phan Đình Phùng cùng khu vực.",
    ...
    benefits: [
      ...
      { icon: BadgePercentIcon, title: "3 gói CORE / PLUS / PRO", desc: "Hệ giá đối tác riêng, ưu đãi ra mắt từ 499.000đ/tháng — giá gốc các gói đều cao hơn." },
    ...
    faqs: [
      ...
      { q: "Gói CORE, PLUS, PRO ở chi nhánh này là gì? Khác gì hệ giá của 89 Phan Đình Phùng?", a: "Đây là bảng giá riêng của hệ đối tác cung cấp không gian tại địa chỉ này, không dùng chung với hệ thống LITE–RISE của các chi nhánh MAX OFFICE khác và cũng khác hệ SILVER/GOLD/PREMIUM tại 89 Phan Đình Phùng. CORE và PLUS cùng giá 499.000đ/tháng nhưng khác định hướng (CORE cho người mới chuyển từ cá nhân/hộ kinh doanh, PLUS cho công ty cần địa chỉ hoạt động hợp lệ, hỗ trợ thay đổi GPKD); PRO 899.000đ/tháng đầy đủ hỗ trợ pháp lý và kế toán cơ bản. Toàn bộ giá chưa bao gồm VAT 10%." },
      { q: "\"Ưu đãi ra mắt MAX\" trên các gói nghĩa là gì?", a: "Cả 3 gói đang áp dụng mức giá thấp hơn giá gốc nhân dịp MAX OFFICE ra mắt địa chỉ đối tác riêng tại 68 Phan Đăng Lưu: CORE và PLUS còn 499.000đ (giá gốc 599.000đ), PRO còn 899.000đ (giá gốc 999.000đ). Bạn nên liên hệ hotline để xác nhận thời hạn ưu đãi còn hiệu lực tại thời điểm ký hợp đồng." },
  ...
  "mac-dinh-chi": {
    ...
    heroDescription:
      "Chi nhánh thứ 2 của MAX OFFICE tại Quận 1 (cũ) — văn phòng ảo 3 gói riêng biệt từ 479.000đ/tháng, đặt tại cao ốc văn phòng nhiều tầng trên trục Mạc Đĩnh Chi, gần Thảo Cầm Viên và khu vực nhiều lãnh sự quán.",
    metaTitle: "Văn Phòng Ảo 36 Mạc Đĩnh Chi, Quận 1 (cũ) | Từ 479K/Tháng",
    metaDescription:
      "Thuê văn phòng ảo tại 36 Mạc Đĩnh Chi, Phường Tân Định — chi nhánh thứ 2 MAX OFFICE tại Quận 1 (cũ), 3 gói SILVER/GOLD/PREMIUM từ 479.000đ/tháng (chưa VAT), gần Thảo Cầm Viên Sài Gòn.",
    image: "/images/khong-gian-lam-viec.jpg",
    ...
    faqs: [
      ...
      { q: "Chi nhánh 36 Mạc Đĩnh Chi khác gì so với chi nhánh Điện Biên Phủ cũng ở Quận 1?", a: "Cả hai cùng thuộc Phường Tân Định nhưng nằm trên 2 trục đường khác nhau và áp dụng 2 bảng giá HOÀN TOÀN KHÁC NHAU: Điện Biên Phủ dùng gói START/BASE thuộc hệ LITE-RISE chung của MAX OFFICE, còn 36 Mạc Đĩnh Chi dùng 3 gói SILVER/GOLD/PREMIUM riêng — cùng bảng giá đang áp dụng tại 2 chi nhánh khu vực Quận 3 (cũ)." },
      { q: "Chi nhánh 36 Mạc Đĩnh Chi áp dụng bảng giá văn phòng ảo nào?", a: "Chi nhánh áp dụng 3 gói: SILVER (479.000đ/tháng), GOLD (639.000đ/tháng) và PREMIUM (990.000đ/tháng) — giá chưa bao gồm VAT 10%, cùng bảng giá đang áp dụng tại 60 Nguyễn Thông và 520 Cách Mạng Tháng 8 (Quận 3 cũ)." },
  ...
  "pasteur": {
    ...
    heroDescription:
      "Chi nhánh thứ 3 của MAX OFFICE tại Quận 1 (cũ) — văn phòng ảo 3 gói riêng biệt từ 479.000đ/tháng, đặt tại toà nhà văn phòng trên trục Pasteur, gần chợ Bến Thành và phố đi bộ Nguyễn Huệ.",
    metaTitle: "Văn Phòng Ảo 28-34 Pasteur, Quận 1 (cũ) | Từ 479K/Tháng",
    metaDescription:
      "Thuê văn phòng ảo tại 28-34 Pasteur, Phường Sài Gòn — chi nhánh thứ 3 MAX OFFICE tại Quận 1 (cũ), 3 gói SILVER/GOLD/PREMIUM từ 479.000đ/tháng (chưa VAT), gần chợ Bến Thành.",
    image: "/images/hero-dia-diem.jpg",
    // Ảnh mặt tiền gốc 1024x1536, không chỉnh sửa.
    facadeAspectRatio: "1024 / 1536",
    facadeImageSide: "left",
    ...
    faqs: [
      ...
      { q: "Chi nhánh 28-34 Pasteur khác gì so với 2 chi nhánh Điện Biên Phủ và 36 Mạc Đĩnh Chi cũng ở Quận 1?", a: "Cả 3 chi nhánh đều ở Quận 1 (cũ) nhưng khác phường và khác bảng giá: Điện Biên Phủ và 36 Mạc Đĩnh Chi cùng thuộc Phường Tân Định, còn 28-34 Pasteur thuộc Phường Sài Gòn. Về giá, Điện Biên Phủ dùng gói START/BASE thuộc hệ LITE-RISE chung, trong khi 36 Mạc Đĩnh Chi và 28-34 Pasteur cùng dùng 3 gói SILVER/GOLD/PREMIUM — bảng giá riêng, giống hệt nhau giữa 2 chi nhánh này." },
      { q: "Chi nhánh 28-34 Pasteur áp dụng bảng giá văn phòng ảo nào?", a: "Chi nhánh áp dụng 3 gói: SILVER (479.000đ/tháng), GOLD (639.000đ/tháng) và PREMIUM (990.000đ/tháng) — giá chưa bao gồm VAT 10%, cùng bảng giá đang áp dụng tại 60 Nguyễn Thông, 520 Cách Mạng Tháng 8 (Quận 3 cũ) và 36 Mạc Đĩnh Chi (Quận 1 cũ)." },
