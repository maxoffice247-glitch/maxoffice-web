...
export const LOCATIONS_DATA: Record<string, LocationData> = {
  ...
  "song-thao": {
    ...
    metaDescription:
      "Thuê văn phòng ảo, văn phòng trọn gói tại Sông Thao, Tân Bình — trụ sở chính MAX OFFICE, đầy đủ dịch vụ, giá từ 299.000đ/tháng, gần sân bay Tân Sơn Nhất.",
    image: IMAGE,
    intro: [
      ...
      "Từ văn phòng ảo với chi phí khởi điểm 299.000đ/tháng đến văn phòng trọn gói sẵn sàng sử dụng ngay, chi nhánh Sông Thao đáp ứng linh hoạt nhu cầu của mọi giai đoạn phát triển doanh nghiệp — từ công ty mới thành lập đến doanh nghiệp đang mở rộng quy mô đội ngũ.",
    ],
  ...
  "dien-bien-phu": {
    ...
    faqs: [
      ...
      { q: "Chi phí thuê văn phòng ảo tại Quận 1 có cao hơn các chi nhánh khác không?", a: "Mức giá vẫn áp dụng theo bảng giá chung của MAX OFFICE, từ 299.000đ/tháng cho văn phòng ảo, không có phụ phí riêng cho vị trí Quận 1." },
  ...
  "nguyen-oanh": {
    ...
    metaTitle: "Văn Phòng Ảo & Trọn Gói Gò Vấp Nguyễn Oanh | Từ 299K/Tháng",
    metaDescription:
      "Thuê văn phòng ảo, văn phòng trọn gói tại Nguyễn Oanh, Gò Vấp — khu vực đông dân, giao thông thuận tiện, giá từ 299.000đ/tháng, phù hợp doanh nghiệp mới.",
    image: IMAGE,
    intro: [
      ...
      "Khu vực Gò Vấp từ lâu đã là nơi tập trung đông đảo dân cư và các hộ kinh doanh nhỏ lẻ, tạo nên môi trường kinh doanh năng động với nhu cầu dịch vụ văn phòng ảo và kế toán thuế cao. Văn phòng Nguyễn Oanh của MAX OFFICE đáp ứng đúng nhu cầu này với mức giá khởi điểm chỉ từ 299.000đ/tháng cho văn phòng ảo.",
    ...
    benefits: [
      { icon: BadgePercentIcon, title: "Chi phí hợp lý", desc: "Giá khởi điểm từ 299.000đ/tháng, phù hợp doanh nghiệp mới khởi nghiệp." },
    ...
    faqs: [
      ...
      { q: "Giá văn phòng ảo tại đây có khác gì so với các chi nhánh khác không?", a: "Không. Mức giá áp dụng đồng nhất trên toàn hệ thống, từ 299.000đ/tháng cho văn phòng ảo." },
  ...
  "yen-the": {
    ...
    heroDescription: "Chi nhánh MAX OFFICE tại Yên Thế, Tân Bình — văn phòng ảo từ 299.000đ/tháng, đầy đủ dịch vụ cốt lõi.",
    metaTitle: "Văn Phòng Ảo & Cho Thuê Văn Phòng Yên Thế Tân Bình | MAX OFFICE",
    metaDescription: "Thuê văn phòng ảo, văn phòng trọn gói tại Yên Thế, Phường Tân Sơn Hòa, Tân Bình — giá từ 299.000đ/tháng, đầy đủ dịch vụ MAX OFFICE.",
    image: IMAGE,
  ...
  "cong-hoa": {
    ...
    heroDescription: "Chi nhánh MAX OFFICE tại Cộng Hoà, Tân Bình — văn phòng ảo từ 299.000đ/tháng, đầy đủ dịch vụ cốt lõi.",
    metaTitle: "Văn Phòng Ảo & Cho Thuê Văn Phòng Cộng Hoà Tân Bình | MAX OFFICE",
    metaDescription: "Thuê văn phòng ảo, văn phòng trọn gói tại Cộng Hoà, Phường Bảy Hiền, Tân Bình — giá từ 299.000đ/tháng, đầy đủ dịch vụ MAX OFFICE.",
    image: IMAGE,
  ...
  "tan-thang": {
    ...
    heroDescription: "Chi nhánh MAX OFFICE tại Tân Thắng, Tân Phú — văn phòng ảo từ 299.000đ/tháng, đầy đủ dịch vụ cốt lõi.",
    metaTitle: "Văn Phòng Ảo & Cho Thuê Văn Phòng Tân Thắng Tân Phú | MAX OFFICE",
    metaDescription: "Thuê văn phòng ảo, văn phòng trọn gói tại Tân Thắng, Phường Tân Sơn Nhì, Tân Phú — giá từ 299.000đ/tháng, đầy đủ dịch vụ MAX OFFICE.",
    image: IMAGE,
  ...
  "cuu-long": {
    ...
    heroDescription: "Chi nhánh MAX OFFICE tại Cửu Long, Tân Bình — văn phòng ảo từ 299.000đ/tháng, đầy đủ dịch vụ cốt lõi.",
    metaTitle: "Văn Phòng Ảo & Cho Thuê Văn Phòng Cửu Long Tân Bình | MAX OFFICE",
    metaDescription: "Thuê văn phòng ảo, văn phòng trọn gói tại Cửu Long, Phường Tân Sơn Hòa, Tân Bình — giá từ 299.000đ/tháng, đầy đủ dịch vụ MAX OFFICE.",
    image: IMAGE,
