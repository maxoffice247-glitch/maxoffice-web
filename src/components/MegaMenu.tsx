                  ...
                  >
                    ...
                    <span>
                      <span className="flex items-center gap-1.5">
                        ...
                        {svc.featured && (
                          <span className="inline-block rounded-full bg-accent px-1.5 py-[3px] text-[9px] font-bold tracking-wide whitespace-nowrap text-white">
                            Phổ biến nhất
                          </span>
                        )}
                      </span>
                      <span className="block text-[12.5px] text-body-text">
                        {svc.desc}
                      </span>
                    </span>
                  </Link>
