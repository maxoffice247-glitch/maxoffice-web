          ...
          >
            <div className="grid grid-cols-[2.2fr_1fr] overflow-hidden rounded-2xl border border-line bg-white shadow-[0_30px_70px_rgba(11,31,58,0.22)]">
              <div className="flex flex-col gap-5 p-6">
                {/* Mỗi danh mục xếp NGANG (grid 3 cột, tự xuống hàng khi
                    >3 mục) thay vì 3 danh mục đặt cạnh nhau theo chiều dọc
                    — cách cũ khiến danh mục nhiều mục nhất (Công cụ tính
                    toán) cao vượt hẳn 2 danh mục kia, kéo dài cả dropdown
                    theo chiều dọc; cách này tận dụng bề ngang sẵn có, các
                    danh mục thấp đều nhau hơn nhiều dù số mục lệch nhau. */}
                {TOOL_GROUPS.map((cat) => (
                  <div key={cat.title}>
              ...
              <div className="flex flex-col justify-between bg-gradient-to-br from-navy to-primary-dark p-6">
                <div>
                  ...
                  <p className="text-[13.5px] leading-relaxed text-white/75">
                    14 công cụ miễn phí giúp bạn tự tra cứu — hoặc gọi ngay để
