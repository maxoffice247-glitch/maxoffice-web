...
const DEFAULT_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "MAX OFFICE hiện có 19 địa điểm tại các quận trung tâm TP.HCM như Tân Bình, Gò Vấp, Tân Phú, Quận 10 và Quận 1 — bạn có thể chọn địa chỉ thuận tiện nhất cho khách hàng và đội ngũ.",
  },
  {
